...
## 3. Hạ tầng Dữ liệu và Logic Đồng bộ

### 3.1. Cấu trúc Cơ sở dữ liệu (Firestore)
...
## 4. Cơ chế Mã hóa và Quyền riêng tư
...
### 4.1. Dẫn xuất Khóa (Key Derivation)
...
## 5. Danh mục Triển khai và Cấu hình
